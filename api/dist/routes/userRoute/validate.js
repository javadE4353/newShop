    ...
    removeMultipleUsers() {
        return [
            body("userIds")
                ...
                else if (param.map((ids) => (typeof ids === "number" ? true : false)).filter((b) => b === false)
                    .length > 0) {
        ...
        return [
            ...
            body("password").custom((password, { req }) => {
                if (!password) {
                    ...
                    return Promise.reject("The password cannot be less than 8 characters or more than 30 characters");
                }
            ...
            body("mobile")
                ...
                if (!value) {
                    ...
                    return Promise.reject("The mobil cannot be less than 11 characters or more than 11 characters");
                }
                else {
                    return true;
                }
    ...
    pagintionUsers() {
        return [
            query("page").custom((page) => {
                ...
                else if (Number.isNaN(Number(page)) === true ||
            ...
            query("size").custom((size) => {
                if (!size) {
                    return true;
                }
                else if (Number.isNaN(Number(size)) === true ||
            ...
            query("username").custom((username) => {
                if (!username) {
                    return true;
                }
